...
public class GUIGameSetup {
    ...
    public String lookedAtLocation;
    public boolean validLookedAtDirection = false;
    ...
    public void look(Location currentLocation, String direction) {
        if (currentLocation.nextLocation.keySet().contains(direction)) {
            ...
            System.out.println();
            this.lookedAtLocation = currentLocation.nextLocation.get(direction).description;
            this.validLookedAtDirection = true;
        } else {
    ...
    // This will start the intro background music
